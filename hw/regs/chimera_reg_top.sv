...
module chimera_reg_top #(
  ...
  logic reset_cluster_5_qs;
  logic reset_cluster_5_wd;
  logic reset_cluster_5_we;
  ...
  prim_subreg #(
    ...
    // from register interface
    .we     (reset_cluster_5_we),
    .wd     (reset_cluster_5_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.reset_cluster_5.q ),

    // to register interface (read)
    .qs     (reset_cluster_5_qs)
  );
  ...
  always_comb begin
    ...
    addr_hit[ 8] = (reg_addr == CHIMERA_SNITCH_CLUSTER_5_RETURN_OFFSET);
    addr_hit[ 9] = (reg_addr == CHIMERA_RESET_CLUSTER_0_OFFSET);
    addr_hit[10] = (reg_addr == CHIMERA_RESET_CLUSTER_1_OFFSET);
    addr_hit[11] = (reg_addr == CHIMERA_RESET_CLUSTER_2_OFFSET);
    addr_hit[12] = (reg_addr == CHIMERA_RESET_CLUSTER_3_OFFSET);
    addr_hit[13] = (reg_addr == CHIMERA_RESET_CLUSTER_4_OFFSET);
    addr_hit[14] = (reg_addr == CHIMERA_RESET_CLUSTER_5_OFFSET);
    addr_hit[15] = (reg_addr == CHIMERA_CLUSTER_0_CLK_GATE_EN_OFFSET);
    addr_hit[16] = (reg_addr == CHIMERA_CLUSTER_1_CLK_GATE_EN_OFFSET);
    addr_hit[17] = (reg_addr == CHIMERA_CLUSTER_2_CLK_GATE_EN_OFFSET);
    addr_hit[18] = (reg_addr == CHIMERA_CLUSTER_3_CLK_GATE_EN_OFFSET);
    addr_hit[19] = (reg_addr == CHIMERA_CLUSTER_4_CLK_GATE_EN_OFFSET);
    addr_hit[20] = (reg_addr == CHIMERA_CLUSTER_5_CLK_GATE_EN_OFFSET);
    addr_hit[21] = (reg_addr == CHIMERA_WIDE_MEM_CLUSTER_0_BYPASS_OFFSET);
    addr_hit[22] = (reg_addr == CHIMERA_WIDE_MEM_CLUSTER_1_BYPASS_OFFSET);
    addr_hit[23] = (reg_addr == CHIMERA_WIDE_MEM_CLUSTER_2_BYPASS_OFFSET);
    addr_hit[24] = (reg_addr == CHIMERA_WIDE_MEM_CLUSTER_3_BYPASS_OFFSET);
    addr_hit[25] = (reg_addr == CHIMERA_WIDE_MEM_CLUSTER_4_BYPASS_OFFSET);
    addr_hit[26] = (reg_addr == CHIMERA_WIDE_MEM_CLUSTER_5_BYPASS_OFFSET);
    addr_hit[27] = (reg_addr == CHIMERA_CLUSTER_0_BUSY_OFFSET);
    addr_hit[28] = (reg_addr == CHIMERA_CLUSTER_1_BUSY_OFFSET);
    addr_hit[29] = (reg_addr == CHIMERA_CLUSTER_2_BUSY_OFFSET);
    addr_hit[30] = (reg_addr == CHIMERA_CLUSTER_3_BUSY_OFFSET);
    addr_hit[31] = (reg_addr == CHIMERA_CLUSTER_4_BUSY_OFFSET);
    addr_hit[32] = (reg_addr == CHIMERA_CLUSTER_5_BUSY_OFFSET);
  end
  ...
  always_comb begin
    wr_err = (reg_we &
              ((addr_hit[ 0] & (|(CHIMERA_PERMIT[ 0] & ~reg_be))) |
               ...
               (addr_hit[28] & (|(CHIMERA_PERMIT[28] & ~reg_be))) |
               (addr_hit[29] & (|(CHIMERA_PERMIT[29] & ~reg_be))) |
               (addr_hit[30] & (|(CHIMERA_PERMIT[30] & ~reg_be))) |
               (addr_hit[31] & (|(CHIMERA_PERMIT[31] & ~reg_be))) |
               (addr_hit[32] & (|(CHIMERA_PERMIT[32] & ~reg_be)))));
  end
  ...
  assign snitch_cluster_5_return_we = addr_hit[8] & reg_we & !reg_error;
  assign snitch_cluster_5_return_wd = reg_wdata[31:0];

  assign reset_cluster_0_we = addr_hit[9] & reg_we & !reg_error;
  assign reset_cluster_0_wd = reg_wdata[0];

  assign reset_cluster_1_we = addr_hit[10] & reg_we & !reg_error;
  assign reset_cluster_1_wd = reg_wdata[0];

  assign reset_cluster_2_we = addr_hit[11] & reg_we & !reg_error;
  assign reset_cluster_2_wd = reg_wdata[0];

  assign reset_cluster_3_we = addr_hit[12] & reg_we & !reg_error;
  assign reset_cluster_3_wd = reg_wdata[0];

  assign reset_cluster_4_we = addr_hit[13] & reg_we & !reg_error;
  assign reset_cluster_4_wd = reg_wdata[0];

  assign reset_cluster_5_we = addr_hit[14] & reg_we & !reg_error;
  assign reset_cluster_5_wd = reg_wdata[0];

  assign cluster_0_clk_gate_en_we = addr_hit[15] & reg_we & !reg_error;
  assign cluster_0_clk_gate_en_wd = reg_wdata[0];

  assign cluster_1_clk_gate_en_we = addr_hit[16] & reg_we & !reg_error;
  assign cluster_1_clk_gate_en_wd = reg_wdata[0];

  assign cluster_2_clk_gate_en_we = addr_hit[17] & reg_we & !reg_error;
  assign cluster_2_clk_gate_en_wd = reg_wdata[0];

  assign cluster_3_clk_gate_en_we = addr_hit[18] & reg_we & !reg_error;
  assign cluster_3_clk_gate_en_wd = reg_wdata[0];

  assign cluster_4_clk_gate_en_we = addr_hit[19] & reg_we & !reg_error;
  assign cluster_4_clk_gate_en_wd = reg_wdata[0];

  assign cluster_5_clk_gate_en_we = addr_hit[20] & reg_we & !reg_error;
  assign cluster_5_clk_gate_en_wd = reg_wdata[0];

  assign wide_mem_cluster_0_bypass_we = addr_hit[21] & reg_we & !reg_error;
  assign wide_mem_cluster_0_bypass_wd = reg_wdata[0];

  assign wide_mem_cluster_1_bypass_we = addr_hit[22] & reg_we & !reg_error;
  assign wide_mem_cluster_1_bypass_wd = reg_wdata[0];

  assign wide_mem_cluster_2_bypass_we = addr_hit[23] & reg_we & !reg_error;
  assign wide_mem_cluster_2_bypass_wd = reg_wdata[0];

  assign wide_mem_cluster_3_bypass_we = addr_hit[24] & reg_we & !reg_error;
  assign wide_mem_cluster_3_bypass_wd = reg_wdata[0];

  assign wide_mem_cluster_4_bypass_we = addr_hit[25] & reg_we & !reg_error;
  assign wide_mem_cluster_4_bypass_wd = reg_wdata[0];

  assign wide_mem_cluster_5_bypass_we = addr_hit[26] & reg_we & !reg_error;
  assign wide_mem_cluster_5_bypass_wd = reg_wdata[0];

  assign cluster_0_busy_we = addr_hit[27] & reg_we & !reg_error;
  assign cluster_0_busy_wd = reg_wdata[0];

  assign cluster_1_busy_we = addr_hit[28] & reg_we & !reg_error;
  assign cluster_1_busy_wd = reg_wdata[0];

  assign cluster_2_busy_we = addr_hit[29] & reg_we & !reg_error;
  assign cluster_2_busy_wd = reg_wdata[0];

  assign cluster_3_busy_we = addr_hit[30] & reg_we & !reg_error;
  assign cluster_3_busy_wd = reg_wdata[0];

  assign cluster_4_busy_we = addr_hit[31] & reg_we & !reg_error;
  assign cluster_4_busy_wd = reg_wdata[0];

  assign cluster_5_busy_we = addr_hit[32] & reg_we & !reg_error;
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[14]: begin
        reg_rdata_next[0] = reset_cluster_5_qs;
      end
