...
#define CHIMERA_SNITCH_CLUSTER_2_RETURN_REG_OFFSET 0x14

// Register to store return value of Snitch cluster 3
#define CHIMERA_SNITCH_CLUSTER_3_RETURN_REG_OFFSET 0x18

// Register to store return value of Snitch cluster 4
#define CHIMERA_SNITCH_CLUSTER_4_RETURN_REG_OFFSET 0x1c

// Register to store return value of Snitch cluster 5
#define CHIMERA_SNITCH_CLUSTER_5_RETURN_REG_OFFSET 0x20

// Soft reset for cluster 0. Active High
#define CHIMERA_RESET_CLUSTER_0_REG_OFFSET 0x24
#define CHIMERA_RESET_CLUSTER_0_RESET_CLUSTER_0_BIT 0

// Soft reset for cluster 1. Active High
#define CHIMERA_RESET_CLUSTER_1_REG_OFFSET 0x28
#define CHIMERA_RESET_CLUSTER_1_RESET_CLUSTER_1_BIT 0

// Soft reset for cluster 2. Active High
#define CHIMERA_RESET_CLUSTER_2_REG_OFFSET 0x2c
#define CHIMERA_RESET_CLUSTER_2_RESET_CLUSTER_2_BIT 0

// Soft reset for cluster 3. Active High
#define CHIMERA_RESET_CLUSTER_3_REG_OFFSET 0x30
#define CHIMERA_RESET_CLUSTER_3_RESET_CLUSTER_3_BIT 0

// Soft reset for cluster 4. Active High
#define CHIMERA_RESET_CLUSTER_4_REG_OFFSET 0x34
#define CHIMERA_RESET_CLUSTER_4_RESET_CLUSTER_4_BIT 0

// Soft reset for cluster 5. Active High
#define CHIMERA_RESET_CLUSTER_5_REG_OFFSET 0x38
#define CHIMERA_RESET_CLUSTER_5_RESET_CLUSTER_5_BIT 0

// Enable clock gate for cluster 0
#define CHIMERA_CLUSTER_0_CLK_GATE_EN_REG_OFFSET 0x3c
#define CHIMERA_CLUSTER_0_CLK_GATE_EN_CLUSTER_0_CLK_GATE_EN_BIT 0

// Enable clock gate for cluster 1
#define CHIMERA_CLUSTER_1_CLK_GATE_EN_REG_OFFSET 0x40
#define CHIMERA_CLUSTER_1_CLK_GATE_EN_CLUSTER_1_CLK_GATE_EN_BIT 0

// Enable clock gate for cluster 2
#define CHIMERA_CLUSTER_2_CLK_GATE_EN_REG_OFFSET 0x44
#define CHIMERA_CLUSTER_2_CLK_GATE_EN_CLUSTER_2_CLK_GATE_EN_BIT 0

// Enable clock gate for cluster 3
#define CHIMERA_CLUSTER_3_CLK_GATE_EN_REG_OFFSET 0x48
#define CHIMERA_CLUSTER_3_CLK_GATE_EN_CLUSTER_3_CLK_GATE_EN_BIT 0

// Enable clock gate for cluster 4
#define CHIMERA_CLUSTER_4_CLK_GATE_EN_REG_OFFSET 0x4c
#define CHIMERA_CLUSTER_4_CLK_GATE_EN_CLUSTER_4_CLK_GATE_EN_BIT 0

// Enable clock gate for cluster 5
#define CHIMERA_CLUSTER_5_CLK_GATE_EN_REG_OFFSET 0x50
#define CHIMERA_CLUSTER_5_CLK_GATE_EN_CLUSTER_5_CLK_GATE_EN_BIT 0

// Bypass cluster to mem wide connection for cluster 0
#define CHIMERA_WIDE_MEM_CLUSTER_0_BYPASS_REG_OFFSET 0x54
...
#define CHIMERA_WIDE_MEM_CLUSTER_1_BYPASS_REG_OFFSET 0x58
...
#define CHIMERA_WIDE_MEM_CLUSTER_2_BYPASS_REG_OFFSET 0x5c
...
#define CHIMERA_WIDE_MEM_CLUSTER_3_BYPASS_REG_OFFSET 0x60
